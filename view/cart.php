					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Cart <span clsas="d-block"> </span></h1>
						...
						<div class="col-lg-7">
                            ...
                            <img src="../theme/imgcart.png" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="container">
                      ...
                      <tbody>
                        <tr>
                          <td class="product-thumbnail">
                            <img src="../theme/nhan1.png" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black">Nhẫn cưới Kim cương Vàng Trắng 14K</h2>
                          </td>
                          <td>$49.00</td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td class="product-name">
                            <h2 class="h5 text-black">Dây chuyền đính đá</h2>
                          </td>
                          <td>$49.00</td>
                          <td>
                            <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label class="text-black h4" for="coupon">Phiếu mua hàng</label>
