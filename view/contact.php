		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
            ...
            <a class="navbar-brand" href="index.html"><img src="../theme/logohq.PNG"></a>
				...
				<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="../view/shop.php">About us</a></li>
						<li><a class="nav-link" href="services.html">Services</a></li>
						<li><a class="nav-link" href="blog.html">Blog</a></li>
						<li class="active"><a class="nav-link" href="../view/contact.php">Contact us</a></li>
					</ul>
				...
				<div class="container">
					<div class="row justify-content-between">
						...
						<div class="intro-excerpt">
								<h1>Contact us<span clsas="d-block"> </span></h1>
						...
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img src="../theme/hoatai1 - Copy.png" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
